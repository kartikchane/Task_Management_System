...
export const cleanUser=(u)=>({id:u._id,name:u.name,email:u.email,role:u.role,department:u.department,designation:u.designation,skills:u.skills,status:u.status,avatar:u.avatar});
